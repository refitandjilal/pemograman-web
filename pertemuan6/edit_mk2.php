    ...
    <!-- ini end modal -->
        ...
        <form id="myform" method="post" action="registrasi_mk2.php">
            <div class="form-group">
                ...
                <input id="kodemk" class="form-control" type="text" name="kodemk" value="<?php echo $_kodemk ?>" readonly <?php echo $jgniseng ?>>
            </div>
            <div class="form-group">
                <label>Nama Mata Kuliah</label>
                <input id="namamk" class="form-control" type="text" name="namamk" value="<?php echo $_namamk ?>" readonly <?php echo $jgniseng ?>>>
            </div>
            <div class="form-group">
